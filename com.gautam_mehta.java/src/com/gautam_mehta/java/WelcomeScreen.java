...
public class WelcomeScreen {
	public static void main(String[] args) {
		...
		WelcomeScreen C = new WelcomeScreen();
		C.crown_method();
	...
	switch (input){
		case 1:
			...
			String file1 = j.nextLine().trim().toLowerCase();
			 try {
			      ...
			      myObj.createNewFile();
			        System.out.println("File created: " + myObj.getName()); //file created
			        filemanager2();
		...
		System.out.println("Search result: " + pathname + "\n");
